 ...
 * </p>
 * <ul>
 *   <li>{@link AuthorizationLayerCIM.impl.AnnResourceImpl#getAnnotatesResource <em>Annotates Resource</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AnnResourceImpl extends AnnotatedElementImpl implements AnnResource {
	...
	protected EClass eStaticClass() {
		return AuthorizationLayerCIMPackage.Literals.ANN_RESOURCE;
	}
		...
		if (annotatesResource != null && annotatesResource.eIsProxy()) {
			...
			if (annotatesResource != oldAnnotatesResource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AuthorizationLayerCIMPackage.ANN_RESOURCE__ANNOTATES_RESOURCE, oldAnnotatesResource, annotatesResource));
			}
		}
	...
	public void setAnnotatesResource(Resource newAnnotatesResource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AuthorizationLayerCIMPackage.ANN_RESOURCE__ANNOTATES_RESOURCE, oldAnnotatesResource, annotatesResource));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AuthorizationLayerCIMPackage.ANN_RESOURCE__ANNOTATES_RESOURCE:
