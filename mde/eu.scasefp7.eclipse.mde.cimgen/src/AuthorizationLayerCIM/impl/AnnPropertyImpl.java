 ...
 * </p>
 * <ul>
 *   <li>{@link AuthorizationLayerCIM.impl.AnnPropertyImpl#getAnnotatesProperty <em>Annotates Property</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AnnPropertyImpl extends AnnotatedElementImpl implements AnnProperty {
	...
	protected EClass eStaticClass() {
		return AuthorizationLayerCIMPackage.Literals.ANN_PROPERTY;
	}
		...
		if (annotatesProperty != null && annotatesProperty.eIsProxy()) {
			...
			if (annotatesProperty != oldAnnotatesProperty) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AuthorizationLayerCIMPackage.ANN_PROPERTY__ANNOTATES_PROPERTY, oldAnnotatesProperty, annotatesProperty));
			}
		}
	...
	public void setAnnotatesProperty(Property newAnnotatesProperty) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AuthorizationLayerCIMPackage.ANN_PROPERTY__ANNOTATES_PROPERTY, oldAnnotatesProperty, annotatesProperty));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AuthorizationLayerCIMPackage.ANN_PROPERTY__ANNOTATES_PROPERTY:
