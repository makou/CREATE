 ...
 * </p>
 * <ul>
 *   <li>{@link AuthorizationLayerCIM.impl.AnnotationModelImpl#getName <em>Name</em>}</li>
 *   <li>{@link AuthorizationLayerCIM.impl.AnnotationModelImpl#getHasAnnotatedElement <em>Has Annotated Element</em>}</li>
 *   <li>{@link AuthorizationLayerCIM.impl.AnnotationModelImpl#getHasAnnotation <em>Has Annotation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AnnotationModelImpl extends MinimalEObjectImpl.Container implements AnnotationModel {
	...
	protected EClass eStaticClass() {
		return AuthorizationLayerCIMPackage.Literals.ANNOTATION_MODEL;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AuthorizationLayerCIMPackage.ANNOTATION_MODEL__NAME, oldName, name));
	}
	...
	public EList<AnnotatedElement> getHasAnnotatedElement() {
		if (hasAnnotatedElement == null) {
			hasAnnotatedElement = new EObjectContainmentEList<AnnotatedElement>(AnnotatedElement.class, this, AuthorizationLayerCIMPackage.ANNOTATION_MODEL__HAS_ANNOTATED_ELEMENT);
		}
	...
	public EList<Annotation> getHasAnnotation() {
		if (hasAnnotation == null) {
			hasAnnotation = new EObjectContainmentEList<Annotation>(Annotation.class, this, AuthorizationLayerCIMPackage.ANNOTATION_MODEL__HAS_ANNOTATION);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AuthorizationLayerCIMPackage.ANNOTATION_MODEL__HAS_ANNOTATED_ELEMENT:
				return ((InternalEList<?>)getHasAnnotatedElement()).basicRemove(otherEnd, msgs);
			case AuthorizationLayerCIMPackage.ANNOTATION_MODEL__HAS_ANNOTATION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AuthorizationLayerCIMPackage.ANNOTATION_MODEL__NAME:
				return getName();
			case AuthorizationLayerCIMPackage.ANNOTATION_MODEL__HAS_ANNOTATED_ELEMENT:
